...
export const getRegisters = async () => {
  return await Axios.get(
    "https://newtech-api.vercel.app/api/v1/admin/research/topic-registration/filter/all",
    {
      headers: {
...
export const approveRegister = async (id) => {
  return await Axios.get(
    "https://newtech-api.vercel.app/api/v1/admin/research/topic-registration/review/approve?id=" + id,
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
